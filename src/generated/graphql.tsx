...
export type LaunchesQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'is_tentative' | 'flight_number' | 'mission_name' | 'launch_success' | 'launch_year'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export type MissionsQuery = (
  ...
  & { missions?: Maybe<Array<Maybe<(
    { __typename?: 'Mission' }
    & Pick<Mission, 'manufacturers' | 'mission_id' | 'mission_name'>
  )>>> }
);
...
export type MissionQuery = (
  ...
  & { mission?: Maybe<(
    { __typename?: 'Mission' }
    & Pick<Mission, 'description' | 'wikipedia' | 'website'>
  )> }
);
...
export function useLaunchQuery(baseOptions: Apollo.QueryHookOptions<LaunchQuery, LaunchQueryVariables>) {
        return Apollo.useQuery<LaunchQuery, LaunchQueryVariables>(LaunchDocument, baseOptions);
      }
export function useLaunchLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchQuery, LaunchQueryVariables>) {
          return Apollo.useLazyQuery<LaunchQuery, LaunchQueryVariables>(LaunchDocument, baseOptions);
        }
